...
<main>
  ...
  <section id="about">
    ...
    <p>글자랑은 서체의 디지털화·시스템화·대중화에 대한 솔루션을 고민하는 스타트업입니다. 현재는 UX, 웹개발, 서체 디자인 분야의 전문가가 모여 새로운 웹서비스를 개발하고 있습니다.
      <br /><br />
      한글 서체 창작자와 사용자들이 오늘날의 디지털 타이포그래피 환경에서 겪는 크고 작은 불편들을 해결하고, 창작자의 워크플로우와 밀접한 서체 솔루션을 만듭니다.
    </p>
  </section>
  <section id="history">
    ...
    <p>이 아이디어는 한글타이포학교의 활자 디자인 과정 수강생의 작은 게으름에서 출발했습니다. 서울대학교 웹 개발 동아리 ‘멋쟁이 사자처럼’에서 첫 아이디어 피칭을 시작으로, 글자에 관심을 가진 사람들이 모였습니다.
      <br /><br />
      작지만 강한 아이디어가 서비스로 거듭날 수 있도록 2022년 글자랑은 기업의 형태로 탈바꿈합니다. 이제 새로운 사업 기회에 도전하며, 폰트 창작자들의 생존도 보장할 수 있는 팀으로 거듭나겠습니다.
    </p>
    <History />
  </section>
  <section id="business">
