<script>
  ...
  function hover(e) {
    if (e.target.classList.contains('sentence') && !e.target.classList.contains('selected')) {
      // 그냥 classList 더했다 뺐다 해서 스타일이 자동으로 적용되게 할 수 있는데 스벨트에서는 그게 안 먹히는 듯...ㅠㅠ 일단 이렇게 냅둠
      e.target.style.backgroundColor = '#FFC8FA'
    }
  }
  ...
  <section>
    ...
    <div class="content">
      ...
      <div class="toggle-container">
        <div class="toggle">
          <div class="border-bottom center sentence" on:click={toggle} on:mouseover={hover} on:mouseout={out}>자발적으로 실험하고 한계에 도전합니다</div>
        ...
        <div class="toggle">
          <div class="border-bottom center sentence" on:click={toggle} on:mouseover={hover} on:mouseout={out}>전문성을 가지고 문제를 해결합니다</div>
          <div class="border-bottom center script">
        ...
        <div class="toggle">
          <div class="border-bottom center sentence" on:click={toggle} on:mouseover={hover} on:mouseout={out}>오픈소스 기반으로 커뮤니티에 기여합니다</div>
          <div class="border-bottom center script">
        ...
        <div class="toggle">
          <div class="border-bottom center sentence" on:click={toggle} on:mouseover={hover} on:mouseout={out}>디지털 문자 생태계의 다양성을 추구합니다</div>
          <div class="border-bottom center script">
